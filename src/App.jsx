      ...
      <div className="min-h-screen bg-neutral-800 flex flex-col items-center justify-center text-center"> 
        <div className="flex items-center justify-center space-x-8 mb-12">
          ...
          <a href="https://react.dev" target="_blank">
            <img 
            src={reactLogo} 
            className="logo react w-25 h-30 animate-spin" 
            alt="React logo" 
        ...
        <h3 className="text-white mb-2">Reza Aditya Prabowo</h3>
        <div className="text-sm mt-3 space-y-6 mb-6">
          <button 
